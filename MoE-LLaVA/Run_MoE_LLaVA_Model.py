...
def main(args):
    disable_torch_init()
    #inp = "Identify this traffic sign"
    inp = "Can you see a car here? only choose either Yes or No" #"As a car driver, which direction should you turn the steering wheel?"
